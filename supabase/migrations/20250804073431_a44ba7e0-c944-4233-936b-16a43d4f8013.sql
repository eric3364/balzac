-- Add certification system tables and modify existing ones
...
-- Add question attempts tracking for incorrect answers (without session_id initially)
...
-- Add test batches to track question sets (without session_id initially)
